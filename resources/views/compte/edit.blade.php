        ...
        <form method="POST" action="{{ route('compte.update', $compte->id) }}">
            ...
            <div class="p-5">
                ...
                <div class="bg-gray-200 flex justify-center items-center p-5 rounded-lg w-full">
                    ...
                    <div class="w-2/3">
                        <input class="border-transparent shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="intitule" name="intitule" placeholder="Nom du compte"
